...
import two from '../../pics/Whitney and James/two.jpg'
...
import twelve from '../../pics/Whitney and James/twelve.jpg'
import thirteen from '../../pics/Whitney and James/thirteen.jpg'
import fourteen from '../../pics/Whitney and James/fourteen.jpg'
import fifteen from '../../pics/Whitney and James/fifteen.jpg'
import sixteen from '../../pics/Whitney and James/sixteen.jpg'
...
class WhitneyAndJames extends React.Component {
    ...
    render() {
        return (
            <div>
                <Header />
                <Template header={star} girlName="Whitney" boyName="James" lastName="Mix" testimony={whitneyTestimony} />
                <div className="container">
                    <div className="picture-grid">
                        ...
                        <PictureForGrid   source={five} description="couple holding wedding sign"/>
                        ...
                        <PictureForGrid  source={sixteen} description="three"/>
                        <PictureForGrid  source={eighteen} description="five"/>
                        <PictureForGrid  source={nineteen} description="six"/>
                    </div>
                </div>
                <div className="reference">
                    <a href={milesBoyer.link}><h3>Photos By:</h3><h3>{milesBoyer.name}</h3></a>
                </div>
                <Footer />
            </div>
        )
